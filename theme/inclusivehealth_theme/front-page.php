...
?>
      <div class="body__container">
        ...
        <p class="about__description">
          ...
          disabilities, visible and invisable. Our website will direct our users
          to educational resources more specific to their situation.
        </p>
        <div class="bio__subcontainer subcontainer">
        ...
        <div class="team__subcontainer subcontainer">
          ...
          <div class="member__container">
            <img src="<?php echo site_url(); ?>/wp-content/themes/inclusivehealth_theme/assets/images/heera.png" alt="" class="team__img" >
            <div class="info__container">
          ...
          <div class="member__container">
          <img src="<?php echo site_url(); ?>/wp-content/themes/inclusivehealth_theme/assets/images/victoria.png" alt="" class="team__img" >
            <div class="info__container">
